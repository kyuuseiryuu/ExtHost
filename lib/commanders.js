...
const create = (yargs) => {
    ...
    const argv = yargs.reset()
        ...
        .help('h')
        .example('new', 'eh a blockBaidu -I=127.0.0.1 -H=map.baidu.com,music.baidu.com')
        .example('new', 'eh a blockBaidu,youkuBlock 将创建一个空的配置')
        .argv;
...
const init = () => {
    ...
    hostConfiger.saveConfig('local', defaultConfig);
    list();
    console.log('已初始化基础配置 local\n');
};
