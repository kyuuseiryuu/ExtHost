...
const buildConfig = (configName, init) => {
    ...
    saveConfig(configName, init, 'create');
    return true;
};
...
const saveConfig = (configName, ipHosts, type='update') => {
    const fullFileName = `${pathname}/${configName}${config.suffix}`;
    const set = {};
    const data = {};
